...
const mangas = [
  {
    ...
    ep: [
      { episode: "1", totalPage: 41, view: 200, created_date: "2025-01-01" },
      { episode: "2", totalPage: 29, view: 100, created_date: "2025-01-02" },
    ],
    tag: tags
  ...
  },
  {
    ...
    ep: [
      { episode: "1", totalPage: 41, view: 100, created_date: "2025-01-21" },
    ],
    tag: tags
      .filter((item) => ["ผจญภัย", "ต่อสู้"].includes(item.name))
      .map((item) => item.name),
